// Increasing the standard deviation of the population that means that the population distribution will have more variation (and will therefore appear wider and flatter)
...
population_mean = 36
population_std_dev = 30    # As the population standard deviation increases, so will the standard error
# Set the sample size:  
samp_size = 1000    # As sample size increases, the standard error will decrease
